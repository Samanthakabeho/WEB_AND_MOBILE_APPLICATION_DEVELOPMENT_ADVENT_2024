...
function calculateTaxiFare(distance, farePerKm) {
    ...
    let distanceToBwaise = 10; // Distance in kilometers
    let farePerKm = 5000; // UGX
    let totalFare = calculateTaxiFare(distanceToBwaise, farePerKm);
    console.log(`Total taxi fare to Bwaise is UGX ${totalFare}`);
