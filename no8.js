...
let farmer1 = new Farmer("Grace", "Mbarara", "Bananas", 10);
let farmer2 = new Farmer("Sam", "Gulu", "Sunflowers", 20);
...
const school1 = new School("Forest Hill College", "Kampala, Uganda", 5000, "Secondary");
const school2 = new School("Kampala Junior School", "Kampala, Uganda", 3000, "Primary");
